...
(function($){
    ...
    Example.Modal.prototype = {
        ...
        addOverlay : function() {
            var html = "";
            html += "<div id='"+this.hash.id+"_overlay' style='display:none;width:100%;height:100%;position:absolute;top:0px;left:0px;opacity:0.5;background-color:#000000;z-Index:999'></div>";

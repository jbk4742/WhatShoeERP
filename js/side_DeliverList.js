...
function addTablePage() {
    ...
    num = 1;
    if(order_len)
        $('#deliverList_page').append('<div id="exPage" onclick="exPage()" style="margin-right: 20px; display: inline-block; cursor: pointer">Pre</div>');
    ...
    $('#deliverList_page').append('<div id="nextPage" onclick="nextPage()" style="margin-left: 20px; display: inline-block; cursor: pointer">Next</div>');
    for(var j = 1 ; j <= 20 ; j++ ){
